...
const Template1 = ({ currentState, updateState }: ResumePreviewProps) => {
    ...
    const renderSection = (section: any) => {
        switch (section?.name) {
            ...
            case "References":
                return <AllReferences data={section} color="#000" templateColor={currentState.color} />;
            case "Languages":
                return <AllLanguages data={section} color="#fff" templateColor="#3358c5" />;
            case "Custom Section":
                return <AllCustomSection secNewNames={secName} data={section} color="#000" templateColor="#fff" />;
            default:
