...
const ImagePopup = () => {
    ...
    const [showResizeControls, setShowResizeControls] = useState(true);
            ...
            <div className="absolute top-0 left-0 z-50 flex items-center justify-center w-full h-dvh bg-zinc-600/80">
                <div className="container">
                    <div className="w-1/4 mx-auto bg-white border border-indigo-200 rounded-md p-10 relative">
                        ...
                        <div
                            className="relative mx-auto min-w-[140px] min-h-[140px] h-[140px] w-[140px] max-w-[200px] max-h-[200px] rounded-full overflow-hidden"
                            onWheel={(e) => {
                                if (isResizing) {
                                    e.preventDefault();
                                    setScale((prev) =>
